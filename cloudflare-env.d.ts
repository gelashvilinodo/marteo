/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 4c6f62aa82c6021d5ac85c7714537b3a)
...
interface __BaseEnv_CloudflareEnv {
	...
	DATABASE_URL: string;
	DIRECT_URL: string;
	SENDSMS_API_KEY: string;
	SENDSMS_BASE_URL: string;
	SENDSMS_SENDER: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "DIRECT_URL" | "SENDSMS_API_KEY" | "SENDSMS_BASE_URL" | "SENDSMS_SENDER" | "RESEND_API_KEY" | "RESEND_FROM_EMAIL">> {}
}
